  ...
  return (
    <footer className="bg-gray-200 dark:bg-gray-900 py-12">
      <div className="container px-8 sm:px-16 py-4 mx-auto">
          ...
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              ...
              <div className="flex mt-4 -mx-2">
                <a href="https://github.com/carinasylvester" className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://github.com/carinasylvester" className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Personal Website" target="_blank" rel="noopener noreferrer">
                  <svg className="text-gray-800 dark:text-white h-4 w-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          <p className="text-center text-gray-800 dark:text-white">© Stock Trading Simulator {new Date().getFullYear()}</p>
        </div>
      </div>
    </footer>
  );
